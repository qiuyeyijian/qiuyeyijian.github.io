import{_ as s,o as a,c as n,O as l}from"./chunks/framework.4afe7240.js";const m=JSON.parse('{"title":"Mysql联合主键","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Database/MySQL/Mysql联合主键.md","filePath":"articles/Database/MySQL/Mysql联合主键.md"}'),e={name:"articles/Database/MySQL/Mysql联合主键.md"},p=l(`<h1 id="mysql联合主键" tabindex="-1">Mysql联合主键 <a class="header-anchor" href="#mysql联合主键" aria-label="Permalink to &quot;Mysql联合主键&quot;">​</a></h1><blockquote><p>联合主键，指的是把两个列看成是一个整体，这个整体是不为空，唯一，不重复</p></blockquote><h3 id="创建表的同时创建联合主键" tabindex="-1">创建表的同时创建联合主键 <a class="header-anchor" href="#创建表的同时创建联合主键" aria-label="Permalink to &quot;创建表的同时创建联合主键&quot;">​</a></h3><div class="language-mysql"><button title="Copy Code" class="copy"></button><span class="lang">mysql</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">create table 表名(</span></span>

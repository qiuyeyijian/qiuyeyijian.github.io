import{_ as s,o as n,c as a,O as l}from"./chunks/framework.571309da.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Language/Verilog/Code.md","filePath":"articles/Language/Verilog/Code.md"}'),p={name:"articles/Language/Verilog/Code.md"},o=l(`<h2 id="verilog-hdl-代码和仿真文件" tabindex="-1">Verilog HDL 代码和仿真文件 <a class="header-anchor" href="#verilog-hdl-代码和仿真文件" aria-label="Permalink to &quot;Verilog HDL 代码和仿真文件&quot;">​</a></h2><h3 id="偶分频器" tabindex="-1">偶分频器 <a class="header-anchor" href="#偶分频器" aria-label="Permalink to &quot;偶分频器&quot;">​</a></h3><h4 id="设计文件" tabindex="-1">设计文件 <a class="header-anchor" href="#设计文件" aria-label="Permalink to &quot;设计文件&quot;">​</a></h4><div class="language-verilog"><button title="Copy Code" class="copy"></button><span class="lang">verilog</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#C792EA;">module</span><span style="color:#F07178;"> </span><span style="color:#FFCB6B;">divider</span><span style="color:#F07178;">(</span></span>

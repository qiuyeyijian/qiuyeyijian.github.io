import{_ as s,o as n,c as a,O as l}from"./chunks/framework.4afe7240.js";const D=JSON.parse('{"title":"Libssh2","description":"","frontmatter":{},"headers":[],"relativePath":"articles/Other/process.md","filePath":"articles/Other/process.md"}'),p={name:"articles/Other/process.md"},e=l(`<h1 id="libssh2" tabindex="-1">Libssh2 <a class="header-anchor" href="#libssh2" aria-label="Permalink to &quot;Libssh2&quot;">​</a></h1><p>在C++中，可以使用操作系统提供的API函数来获取进程退出状态码，以下是在Windows和Linux系统下获取进程退出状态码的方法：</p><ol><li>Windows系统：</li></ol><p>在Windows系统中，可以使用CreateProcess函数来创建子进程，WaitForSingleObject函数来等待子进程退出，GetExitCodeProcess函数来获取子进程的退出状态码。具体示例代码如下：</p><div class="language-c++"><button title="Copy Code" class="copy"></button><span class="lang">c++</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">#include &lt;windows.h&gt;</span></span>
